...
namespace NServiceKit.OrmLite.FirebirdTests.Expressions
{
    ...
    public class PrimaryExpressionsTest : ExpressionsTestBase
    {
        ...
        private class TestClass<T>
        {
            ...
            /// NServiceKit.OrmLite.FirebirdTests.Expressions.PrimaryExpressionsTest.TestClass&lt;T&gt;
            /// class.
            /// </summary>
            /// <param name="value">The value.</param>
        ...
        private struct TestStruct<T>
        {
            ...
            /// <summary>
            /// Initializes a new instance of the
            /// NServiceKit.OrmLite.FirebirdTests.Expressions.PrimaryExpressionsTest class.
            /// </summary>
            /// <param name="value">The value.</param>
