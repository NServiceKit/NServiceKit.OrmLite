namespace NServiceKit.OrmLite.Tests
{
    ...
    /// <summary>An ORM lite execute non query tests.</summary>
    [TestFixture]
    public class OrmLiteExecuteNonQueryTests
    {
        /// <summary>An using anon type.</summary>
        public class UsingAnonType : OrmLiteTestBase
        {
            /// <summary>Can insert one row and get one affected row.</summary>
            [Test]
            ...
            /// <summary>Can insert multiple rows and get matching number of affected rows.</summary>
            [Test]
            ...
            /// <summary>Can update and returns appropriate number of affected rows.</summary>
            [Test]
            ...
            /// <summary>Can delete and returns appropriate number of affected rows.</summary>
            [Test]
            ...
            /// <summary>
            /// Can execute statement which performs no changes and returns no affected rows.
            /// </summary>
            [Test]
        ...
        /// <summary>Dictionary of usings.</summary>
        ...
        /// <summary>A without parameters.</summary>
