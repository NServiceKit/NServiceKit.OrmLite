...
namespace NServiceKit.OrmLite.Tests
{
    ...
    /// <summary>A SQL server provider tests.</summary>
    [TestFixture]
    public class SqlServerProviderTests
    {
        ...
        /// <summary>Can SQL list stored proc returning table.</summary>
        [Test]
...
END;";
        ...
        /// <summary>Can SQL list stored proc returning column.</summary>
        [Test]
...
END;";
        ...
        /// <summary>Can SQL list stored proc returning string column.</summary>
        [Test]
...
END;";
        ...
        /// <summary>Can SQL list stored proc returning scalar.</summary>
        [Test]
...
END;";
        ...
        /// <summary>Can SQL scalar stored proc passing null parameter.</summary>
        [Test]
...
END;";
        ...
        /// <summary>Can SQL list stored proc passing null parameter.</summary>
        [Test]
...
END;";
        ...
        /// <summary>Can SQL list stored proc receiving only first column and null.</summary>
        [Test]
