...
{
    /// <summary>An insert northwind data scenario.</summary>
	public class InsertNorthwindDataScenario
		: DatabaseScenarioBase
{
        /// <summary>
        /// Initializes static members of the
        /// NServiceKit.OrmLite.TestsPerf.Scenarios.Northwind.InsertNorthwindDataScenario class.
        /// </summary>
        ...
        /// <summary>Inserts a data described by db.</summary>
        /// <param name="db">The database.</param>
