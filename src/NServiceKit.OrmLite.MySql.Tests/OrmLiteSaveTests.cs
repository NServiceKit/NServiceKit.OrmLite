...
{
    /// <summary>An ORM lite save tests.</summary>
	[TestFixture]
	public class OrmLiteSaveTests
		: OrmLiteTestBase
	{
        /// <summary>Can save into model with fields of different types table.</summary>
		[Test]
        ...
        /// <summary>Can save and select from model with fields of different types table.</summary>
		[Test]
        ...
        /// <summary>
        /// Can save all and select from model with fields of different types table.
        /// </summary>
		[Test]
        ...
        /// <summary>
        /// Can save all and select from model with fields of different types table with no
        /// identifiers.
        /// </summary>
		[Test]
        ...
        /// <summary>Can save table with null fields.</summary>
		[Test]
        ...
        /// <summary>Can save task queue table.</summary>
		[Test]
        ...
        /// <summary>Can save all and select from movie table.</summary>
		[Test]
