...
namespace NServiceKit.OrmLite.MySql.Tests.Expressions
{
    /// <summary>An author use case.</summary>
    public class AuthorUseCase : OrmLiteTestBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the NServiceKit.OrmLite.MySql.Tests.Expressions.AuthorUseCase
        /// class.
        /// </summary>
        ...
        /// <summary>Author uses cases.</summary>
        [Test]
