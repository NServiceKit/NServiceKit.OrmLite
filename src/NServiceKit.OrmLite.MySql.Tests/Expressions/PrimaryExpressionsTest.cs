...
namespace NServiceKit.OrmLite.MySql.Tests.Expressions
{
    ...
    public class PrimaryExpressionsTest : ExpressionsTestBase
    {
        ...
        private class TestClass<T>
        {
            ...
            /// NServiceKit.OrmLite.MySql.Tests.Expressions.PrimaryExpressionsTest.TestClass&lt;T&gt;
            /// class.
            /// </summary>
            /// <param name="value">The value.</param>
        ...
        private struct TestStruct<T>
        {
            ...
            /// <summary>
            /// Initializes a new instance of the
            /// NServiceKit.OrmLite.MySql.Tests.Expressions.PrimaryExpressionsTest class.
            /// </summary>
            /// <param name="value">The value.</param>
