...
{
    /// <summary>test for issue #69.</summary>
    class UnicodeTests : OrmLiteTestBase
    {
        /// <summary>Can insert and retrieve unicode values.</summary>
        [Test]
...
select * from Unicode_poco
        ...
        /// <summary>An unicode poco.</summary>
        ...
        /// <summary>because OrmLite does not create nvarchar columns.</summary>
