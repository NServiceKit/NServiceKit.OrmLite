...
{
    /// <summary>An oracle parameter tests.</summary>
    [TestFixture]
    public class OracleParamTests : OracleTestBase
    {
        /// <summary>Drop and create tables.</summary>
        ...
        /// <summary>Ora parameter test insert.</summary>
        [Test]
        ...
        /// <summary>Ora parameter test update.</summary>
        [Test]
        ...
        /// <summary>Ora parameter test delete.</summary>
        [Test]
        ...
        /// <summary>Ora parameter test get by identifier.</summary>
        [Test]
        ...
        /// <summary>Ora parameter test select lambda.</summary>
        [Test]
        ...
        /// <summary>Ora parameter test select lambda 2.</summary>
        [Test]
        ...
        /// <summary>Ora parameter test select lambda complex.</summary>
        [Test]
        ...
        /// <summary>Tests ora parameter byte.</summary>
        [Test]
        ...
        /// <summary>A parameter test bo.</summary>
        public class ParamTestBO
        {
            ...
            /// <summary>Gets or sets the nullable bool.</summary>
            /// <value>The nullable bool.</value>
        ...
        /// <summary>A parameter relative bo.</summary>
        public class ParamRelBO
        {
            ...
            /// <summary>Gets or sets the identifier of the point.</summary>
            /// <value>The identifier of the point.</value>
        ...
        /// <summary>A parameter byte bo.</summary>
