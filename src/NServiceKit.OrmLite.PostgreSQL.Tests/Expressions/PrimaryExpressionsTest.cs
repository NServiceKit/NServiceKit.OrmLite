...
namespace NServiceKit.OrmLite.PostgreSQL.Tests.Expressions
{
    ...
    public class PrimaryExpressionsTest : ExpressionsTestBase
    {
        ...
        private class TestClass<T>
        {
            ...
            /// NServiceKit.OrmLite.PostgreSQL.Tests.Expressions.PrimaryExpressionsTest.TestClass&lt;T&gt;
            /// class.
            /// </summary>
            /// <param name="value">The value.</param>
        ...
        private struct TestStruct<T>
        {
            ...
            /// <summary>
            /// Initializes a new instance of the
            /// NServiceKit.OrmLite.PostgreSQL.Tests.Expressions.PrimaryExpressionsTest class.
            /// </summary>
            /// <param name="value">The value.</param>
