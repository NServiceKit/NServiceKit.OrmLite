...
{
    /// <summary>A write extensions.</summary>
    public static class WriteExtensions
    {
        /// <summary>
        /// Use an expression visitor to select which fields to update and construct the where expression,
        /// E.g:
        /// 
        ///   dbCmd.UpdateOnly(new Person { FirstName = "JJ" }, ev => ev.Update(p => p.FirstName).Where(x
        ///   => x.FirstName == "Jimi"));
        ///   UPDATE "Person" SET "FirstName" = 'JJ' WHERE ("FirstName" = 'Jimi')
        /// 
        ///   What's not in the update expression doesn't get updated. No where expression updates all
        ///   rows. E.g:
        /// 
        ///   dbCmd.UpdateOnly(new Person { FirstName = "JJ", LastName = "Hendo" }, ev => ev.Update(p =>
        ///   p.FirstName));
        ...
        ///   dbCmd.UpdateOnly(new Person { FirstName = "JJ" }, ev.Update(p => p.FirstName).Where(x =>
        ///   x.FirstName == "Jimi"));
        ///   UPDATE "Person" SET "FirstName" = 'JJ' WHERE ("FirstName" = 'Jimi')
        /// 
        ///   What's not in the update expression doesn't get updated. No where expression updates all
        ///   rows. E.g:
        /// 
        ///   dbCmd.UpdateOnly(new Person { FirstName = "JJ", LastName = "Hendo" }, ev.Update(p =>
        ///   p.FirstName));
        ///   UPDATE "Person" SET "FirstName" = 'JJ'.
        /// </summary>
        /// <typeparam name="T">Generic type parameter.</typeparam>
        ...
        /// <summary>
        /// Update record, updating only fields specified in updateOnly that matches the where condition
        /// (if any), E.g:
        /// 
        ///   dbCmd.UpdateOnly(new Person { FirstName = "JJ" }, p => p.FirstName, p => p.LastName ==
        ///   "Hendrix");
        ...
        ///   UPDATE "Person" SET "Id" = 1,"FirstName" = 'JJ',"LastName" = NULL,"Age" = 0 WHERE
        ///   ("LastName" = 'Hendrix')
        /// </summary>
        /// <typeparam name="T">Generic type parameter.</typeparam>
        /// <param name="dbCmd">The dbCmd to act on.</param>
        ...
        /// <summary>
        /// Flexible Update method to succinctly execute a free-text update statement using optional
        /// params. E.g:
        /// 
        ///   dbCmd.Update&lt;Person&gt;(set:"FirstName = {0}".Params("JJ"), where:"LastName =
        ///   {0}".Params("Hendrix"));
        ///   UPDATE "Person" SET FirstName = 'JJ' WHERE LastName = 'Hendrix'.
        /// </summary>
        /// <typeparam name="T">Generic type parameter.</typeparam>
        ...
        /// params. E.g.
        /// 
        ///   dbCmd.Update(table:"Person", set: "FirstName = {0}".Params("JJ"), where: "LastName =
        ///   {0}".Params("Hendrix"));
        ///   UPDATE "Person" SET FirstName = 'JJ' WHERE LastName = 'Hendrix'.
        /// </summary>
        /// <exception cref="ArgumentNullException">Thrown when one or more required arguments are null.</exception>
        ...
        /// <summary>
        /// Flexible Delete method to succinctly execute a delete statement using free-text where
        /// expression. E.g.
        /// 
